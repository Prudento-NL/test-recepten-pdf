...
date:   2021-10-23
---
Nog eens terugkijkend naar de oplossing in [5-dit-is-de-oplossing](/5-dit-is-de-oplossing.html) zie ik toch een probleem.
...
- Geprobeerd om `file-path contains` aan te passen naar `file-path ==` maar nog zonder succes.


## Conclusie:
- Recepten in een volledig eigen directory te zetten en het 'file-path' laten verwijzen naar deze directory.